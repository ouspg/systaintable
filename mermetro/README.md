...
Entries that appear in `mermetro/data/filtered_entries.txt` are excluded from grouping process. Add most common values and any other not informative entries here for better results.
...
v2 presents information using diagrams that v1 presents in text-only
